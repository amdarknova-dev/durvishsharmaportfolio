  ...
  return (
    ...
    >
      <div className="fixed bottom-0 h-[800px] w-full">
        <div className="bg-[#050505] h-full flex flex-col justify-between py-24 px-6 border-t border-white/5">
          <div className="max-w-7xl mx-auto w-full h-full flex flex-col justify-between">
            ...
            {/* Massive Typography */}
            <div className="w-full overflow-hidden flex justify-center py-12">
              <motion.h1
                initial={{ y: "100%" }}
                whileInView={{ y: 0 }}
                viewport={{ once: false }}
                transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
                className="text-[12vw] leading-[0.8] font-black uppercase text-white/5 tracking-tighter text-center whitespace-nowrap select-none"
              >
                DURVISH SHARMA
              </motion.h1>
            </div>
            ...
            {/* Bottom Section */}
            <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-12 text-[10px] font-mono text-gray-700 uppercase tracking-[0.3em]">
